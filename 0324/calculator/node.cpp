/*************************************************************************
  ...
  > Created Time: Tue 24 Mar 2015 09:31:44 PM CST
 ************************************************************************/
...
#if 1
MultipleNode::MultipleNode(Node *child)
{
	addChild(child, true);
}
#endif
...
void MultipleNode::addChild(Node *child, bool positive)
{
	vec_childs_.push_back(child);
